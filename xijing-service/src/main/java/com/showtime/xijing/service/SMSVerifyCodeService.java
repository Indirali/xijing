...
public class SMSVerifyCodeService {
    ...
    private static String API_KEY = "7936e927f6e6d9b91593722fbc05b548";
    private static String YUN_PIAN_VERIFYTEXT = "【戏鲸汇演】 您的验证码是";
    private static String YUN_PIAN_POSTFIX = "(5分钟之内有效,如非本人操作,请忽略)";
